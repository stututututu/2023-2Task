...
public class DbCreat {
	...
	public DbCreat() {
		...
		int result = DbManager.db.setData("-- MySQL Script generated by MySQL Workbench\r\n"
				+ "-- Mon Mar 27 09:29:30 2023\r\n"
				...
				+ "");
		int result1 = 0;
		Vector<Vector<String>> bookData = DbManager.db.getData("SELECT b_no FROM 2023지방_2.book;");
