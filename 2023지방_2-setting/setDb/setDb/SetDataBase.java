...
public class SetDataBase {
	...
	public SetDataBase() {
		...
		db = new DbManager();
			...
			int result = db.setData("-- MySQL Script generated by MySQL Workbench\r\n"
					...
					+ ""
					+ "load data local infile './datafiles/user.txt' into table user lines terminated by '\\r' ignore 1 lines; \r\n"
					+ "load data local infile './datafiles/division.txt' into table division lines terminated by '\\r' ignore 1 lines; \r\n"
					+ "load data local infile './datafiles/book.txt' into table book lines terminated by '\\r\\n' ignore 1 lines; \r\n"
					+ "load data local infile './datafiles/likebook.txt' into table likebook lines terminated by '\\r' ignore 1 lines; \r\n"
					+ "load data local infile './datafiles/rental.txt' into table rental lines terminated by '\\r' ignore 1 lines; \r\n"
					+ "\r\n"
					+ "\r\n"
...
//				+ "grant insert, delete, update, select on 2023지방_2.* to 'user'@'localhost';");
			...
			for (Vector<String> vector : num) {
				
			
				File file = new File("./datafiles/book/" + vector.get(0) +".jpg");
					try {
