...
public class DbCreat {
	...
	public DbCreat() {
		...
		int result = DbManager.db.setData("\r\n"
				...
				+ "grant update, insert, select, delete on 2023지방_2.* to 'user'@'localhost';\r\n"
				+ "\r\n"
				+ "");
		
		int result1 = 0;
		Vector<Vector<String>> book = DbManager.db.getData("SELECT * FROM 2023지방_2.book;");
		for (Vector<String> val : book) {
			File file = new File("./datafiles/book/"+ val.get(0) + ".jpg");
